...
class UmengAnalyticsPlugin {
  ...
  static const MethodChannel _channel =
      MethodChannel('cc.yourdream/umeng_analytics');
  ...
  static Future<bool> event(String eventId,
      {String label = 'label',
      Map<String, dynamic> params,
      int eventValue}) async {
    Map<String, dynamic> map = {
      'eventId': eventId,
    };
    ...
    if (params != null) {
      map['params'] = json.encode(params);
    }

    map['eventValue'] = eventValue ?? -1;
